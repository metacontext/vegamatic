...
/**
 * Test case for class Tx_Vegamatic_Controller_WeeksController.
 *
 * @version $Id$
 ...
 */
class Tx_Vegamatic_Controller_WeeksControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
