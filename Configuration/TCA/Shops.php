...
$TCA['tx_vegamatic_domain_model_shops'] = array(
	'ctrl' => $TCA['tx_vegamatic_domain_model_shops']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_vegamatic_domain_model_shops.pid=###CURRENT_PID### AND tx_vegamatic_domain_model_shops.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:vegamatic/Resources/Private/Language/locallang_db.xml:tx_vegamatic_domain_model_shops.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
